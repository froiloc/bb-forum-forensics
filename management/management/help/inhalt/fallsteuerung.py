...
ASSIGNMENT = Sichthilfe(
    ...
    abschnitte=(
        ...
        Abschnitt(
            "rechte", "Rechtelage",
            (
                "assignment.edit mit Scope „alle“. Dieselbe Fähigkeit trägt "
                "auch die Fall-Erkennung — dafür wurde bewusst keine zweite "
                "Fähigkeit eingeführt.",
                "Der Server prüft jede Änderung noch einmal selbst. Was die "
                "Oberfläche anbietet, ist nie die Erlaubnis; die Erlaubnis "
                "liegt im Schreibpfad.",
            ),
        ),
        Abschnitt(
            "aufbau", "Aufbau der Sicht",
        ...
        Abschnitt(
            ...
            (
                ...
                "Nach einer bestätigten Einzeländerung wird seit Build 534 nur "
                "die betroffene Zeile aktualisiert. Sortierung, Filter, "
        ...
        Abschnitt(
            ...
            (
                ...
                "steht so auch in der Datenbank.",
...
CASES = Sichthilfe(
    ...
    recht_klartext=(
        "Recht: assignment.edit — dieselbe Fähigkeit wie die Zuweisung. Es "
        "wurde bewusst keine zweite eingeführt: wer Fälle verteilen darf, darf "
    ...
    abschnitte=(
        ...
        Abschnitt(
            ...
            (
                ...
                "— genau die Menge, die der Server auch annehmen würde. Die "
