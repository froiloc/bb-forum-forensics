# =============================================================================
# management/migrations/assets/m001_baseline.py
# IT-Forensisches Ermittlungswerkzeug — Baustelle 7: Management-Interface
# =============================================================================
# Baseline-Migration (Build 319) fuer assets_<uid>.db.
#
...
VERSION = 1
NAME = "baseline assets (schema_migrations-Registry, additiv/datenneutral)"
KIND = "additive"
...
def up(con):
    ...
    # zuvor angelegt). So wird keine leere/falsche Datei als assets-DB
    # gebaselined.
    row = con.execute(
