...
def _resolve_db_path(args) -> str:
    ...
    '[person_admin]'. Die Abbruchmeldung nennt jetzt BEIDE Wege statt nur einen.
    """
    return werkzeug_konfig.db_pfad(
        "person_admin", args, arg_attribut="coordinator_db", arg_name="--coordinator-db",
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=cli_epilog.epilog("person_admin"),
