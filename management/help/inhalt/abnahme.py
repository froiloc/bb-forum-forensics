    ...
    abschnitte=(
        ...
        Abschnitt(
            ...
            (
                ...
                "EINE GEÄNDERTE ANNOTATION IST NICHT VERLOREN. Wird eine "
                "Annotation bearbeitet, entsteht eine NEUE Fassung mit einer "
                "neuen Nummer; die bisherige bleibt als Vorgänger erhalten. "
                "Ein Vollzitat, das noch die alte Nummer führt, folgt der "
                "Versionskette bis zur aktuellen Fassung und zitiert diese. DER AUSTAUSCH GESCHIEHT NICHT STILL: unter "
                "„Hinweise zur Erzeugung“ steht dann, welche Nummer als "
                "welche fortgeführt wird und über welche Zwischenfassungen — "
                "in einer Akte darf kein anderer Datensatz unbemerkt an die "
                "Stelle des zitierten treten. Die frühere Fassung bleibt über "
                "die Versionskette einsehbar.",
                ...
                "gibt. Diese Überschrift erscheint erst, NACHDEM die "
                "Versionskette vorwärts verfolgt wurde und ohne aktuelle "
                "Fassung endet; „ersetzt“ und „gelöscht“ werden also "
                "unterschieden. Alle diese Befunde sammelt zusätzlich der Abschnitt "
                ...
                "DIE ZEITZONE IST JETZT GEKLÄRT — und sie wird bei jeder "
                "Markierung AUS DER SEITE GELESEN, nicht angenommen. Die "
                "Fußzeile des Forums nannte sie ausdrücklich; wo sie dort "
                "steht, wird die Uhrzeit zusätzlich in der weltweit "
                "einheitlichen Zeit festgehalten. Steht dort eine andere "
                "Zone oder gar keine, unterbleibt die Umrechnung — dann "
                "bleibt es bei der Angabe, wie sie auf der Seite stand, und "
                "ein Hinweis sagt das.",
                "MASSGEBLICH BLEIBT DIE ANGABE VON DER SEITE. Die "
                "umgerechnete Fassung ist eine Bequemlichkeit für die "
                "Auswertung, nicht die Quelle. WERTEN SIE EINE ZEIT OHNE "
                "ZONENANGABE NICHT UNGEPRÜFT ALS ORTSZEIT — eine Tatzeit in "
                "der falschen Zone ist um Stunden falsch und sieht dabei aus "
                "wie eine richtige.",
                "NEUE MARKIERUNGEN TRAGEN MEHR MIT ALS FRÜHER: die Nummer "
                "des Unterforums und des Themas, die Seitenzahl, den "
                "Benutzertitel des Verfassers, seine Angaben aus der linken "
                "Beitragsspalte und die Verweise, über die sich derselbe "
                "Beitrag anderswo wiederfinden lässt. Nicht alles davon wird "
                "heute im Vermerk gezeigt. Es wird gesichert, weil es später "
                "gebraucht werden kann und dann nicht mehr zu beschaffen "
                "wäre — die Seiten von damals lassen sich nicht noch einmal "
                "abrufen.",
