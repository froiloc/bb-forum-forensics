...
class ManagementDashboardTests(unittest.TestCase):
    ...
    def test_d01_migrations_and_empty(self):
        ...
        # Build 504: M022 (subject_alias — globaler Alias-Katalog, OHNE
        ...
        # ohne RBAC-Seed);
        # Build 515: M026 (RBAC-Seed escalation.view fuer die Eskalations-
        # Sicht, AP-2G/Idee 23 — reiner Capability-Seed, keine Zeile beruehrt);
        # Build 517: M027 (escalation_ack — Quittierung von Eskalationen, NEUE
        ...
        # Build 524: M031 (RBAC-Seed limitation.view fuer den Verjaehrungs-
