...
def _resolve_db_path(args) -> str:
    ...
    '[migrate_templates_placeholders]'. Die Abbruchmeldung nennt jetzt BEIDE Wege statt nur einen.
    """
    return werkzeug_konfig.db_pfad(
        "migrate_templates_placeholders", args, arg_attribut="templates_db", arg_name="--templates-db",
