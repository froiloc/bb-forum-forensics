# =============================================================================
# management/migrations/forensic/m001_baseline.py
# IT-Forensisches Ermittlungswerkzeug — Baustelle 7: Management-Interface
# =============================================================================
# Baseline-Migration (Build 319) fuer forensic_<uid>.db.
#
...
VERSION = 1
NAME = "baseline forensic (schema_migrations-Registry, additiv/datenneutral)"
KIND = "additive"
...
def up(con):
    ...
    # zuvor angelegt). So wird keine leere/falsche Datei als forensic-DB
    # gebaselined.
    row = con.execute(
